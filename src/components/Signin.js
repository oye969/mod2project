    ...
    <div className="App-wrapper">
      <div className="Header-top">
        ...
        <div className="display-songs">
            <h3>SIGN IN</h3>
            <h4>
            To sign up you need a valid email address. To receive text messages you need to a valid mobile phone number. Select the topics you're interested in and we'll send you the updates. You'll receive a confirmation notice afterwards, and you can easily update your preferences anytime.
            </h4>
